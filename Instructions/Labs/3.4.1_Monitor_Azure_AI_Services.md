---
lab:
  title: 'AI Ready Manage hands-on exercise: Monitoring Azure AI Services'
  description: Azure Monitor provides a unified framework for collecting, analyzing,
    and acting on telemetry from Azure resources, including Microsoft Foundry. It
    captures platform metrics and resource logs to help you understand the performance,
    availability, and operational behavior of your AI workloads. Platform metrics
    are automatically collected and stored in the Azure Monitor time-series database.
    These metrics are lightweight, support near real-time alerting, and are used to
    track resource performance trends over time.
  duration: 25 minutes
  level: 400
  islab: true
  primarytopics:
...
### Task 2: Review Microsoft Foundry project metrics
...
### Task 3: Create a Microsoft Foundry project alert rule
...
1. On the **Details** tab, specify the following settings (leave others with their default values) and select **Review + create**:
   ...
   |Alert rule description|**Triggers when the average Microsoft Foundry project resource availability rate falls below 100%, indicating a potential service disruption**|
...
### Task 4: Create a Microsoft Foundry project alert processing rule
